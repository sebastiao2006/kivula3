...
@php
  ...
  $faqs = ProductFaq::where('product', 'product1')->get();
  $plans = ProductPlan::where('product', 'product1')->get();
@endphp
        ...
        <div class="col-lg-4" data-aos="fade-up" data-aos-delay="{{ 100 * ($index + 1) }}">
          <div class="pricing-card {{ $plan->popular ? 'popular' : '' }}">
            ...
            <div class="price">
             ...
             <span class="amount">
  {{ is_numeric($plan->price) ? number_format((float) $plan->price, 2, ',', '.') : '0,00' }}
</span>
...
<ul class="features-list">
  ...
  @endforeach
            ...
            <a href="#" class="btn {{ $plan->popular ? 'btn-light' : 'btn-primary' }}">
              Buy Now
